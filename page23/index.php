...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	  ...
	  <title>Suggested Pictures | Vivian Cronin Art</title>
	  ...
	  <script>
		...
		<meta class="stacks3 stack version" id="com.joeworkman.stacks.dispatch2.server" name="Dispatch Server" content="2.2.5">
		<meta class="stack version" id="com.joeworkman.stacks.dispatch2.server" name="Dispatch Server" content="2.2.5">
...
<div id='stacks_out_238_page23' class='stacks_top'><div id='stacks_in_238_page23' class=''><div id='stacks_out_252_page23' class='stacks_out'><div id='stacks_in_252_page23' class='stacks_in text_stack'>If you have a photograph that you would like to see me paint, I would love to see it.  </div></div><div id='stacks_out_239_page23' class='stacks_out'><div id='stacks_in_239_page23' class='stacks_in com_joeworkman_stacks_dispatch2_server_stack'>
	<?php if (version_compare(PHP_VERSION, '5.2.0', '<')) echo '<p>You need at least PHP v5.2.0 to use this stack. You have version ' . PHP_VERSION . '</p>'; ?>
	<script src="files/swfupload.js"></script>


<div class="queue_wrapper"><div id="queue_stacks_in_239_page23" class="empty"></div></div>
<form id="form_stacks_in_239_page23">
    ...
    <div class="button_wrapper">
		...
		<div class="browse_button">
				...
				<input type="file" name="uploadifive" id="uploadifive_stacks_in_239_page23" multiple="true"/>
				<input type="file" name="uploadify" id="uploadify_stacks_in_239_page23" style="display:none" multiple="true"/>
			...
			<div class="upload_button">
					...
					<div class="dispatch-button">Upload</div>
